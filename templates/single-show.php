			...
			<div id="content" role="main">
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div class="entry-content">
						...
						<?php
							...
							if ( $djs ) {
								foreach( $djs as $dj ) {
									...
									if ( ( ( $count == 1 ) && ( count($djs) == 2 ) )
									  || ( ( count($djs) > 2 ) && ( $count == ( count($djs) - 1 ) ) ) ) {
										echo ' and ';
								...
								<?php
									...
									if ( $shifts ) {
										foreach ( $shifts as $shift ) {
											...
											echo '<li>';
											echo $weekday.' - '.$shift['start_hour'].':'.$shift['start_min'].' '.$shift['start_meridian'].' - '.$shift['end_hour'].':'.$shift['end_min'].' '.$shift['end_meridian'];
											echo '</li>';
										}
									}
						...
						<?php echo radio_station_myplaylist_get_posts_for_show( get_the_ID(), __( 'Blog Posts', 'radio-station' ), '10' ); ?>
